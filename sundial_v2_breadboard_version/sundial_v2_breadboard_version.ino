...
#include <Arduino.h>
//EEPROM
//**make change: software wire no longer needed, encoder doesn't need interrupt, temporarily keeping to program legacy v1 board**//
#include <Wire.h> //for saving to external chip eeprom, software wire is used to save interrupt pins for rotary encoder - interrupt pins freed up in v2, used for external eeprom now
#include <EEPROM.h> //for saving to internal eeprom memory
//MIDI
#include <MIDI.h>
#include <USB-MIDI.h> //companion to MIDI.h for usb use
...
#define MIDI_SUPPRESS_PIN 11 //controls transistor link between MIDI out and VS1053B in
